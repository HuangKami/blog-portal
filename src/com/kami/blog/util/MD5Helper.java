...
public class MD5Helper {
	...
	public static String md5(String data) {
		...
		return hf.newHasher().putString(hash.toString(), defaultCharset).hash().toString();
	}
	...
	/**
	 * @param object
	 *            只能是封装了数据的实体类，不可以是map，List等
	 * @param fieldNames
	 *            需要参与md5计算的字段属性名，如果该属性也是一个封住数据实体类话，.后跟上具体属性名即可。如：role.level.id
	 * @param isUpperCase
	 *            结果是否大写
	 * @param charset
	 *            涉及到字符串时的操作编码，默认是utf-8
