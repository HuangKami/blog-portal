...
public interface FollowDao{
	 ...
	 * @return
	 */
    int updateFollow(@Param("enti") Follow value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyFollow(@Param("enti") Follow value, @Param("assist") Assist assist);
    /**
     * 查询关注
     */
